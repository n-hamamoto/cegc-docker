...
echo 'download cegc source'
git clone https://github.com/n-hamamoto/cegc.git

echo 'copy source to php container volume'
mkdir -p ../php/html
cp -r ./cegc/. ../php/html/
